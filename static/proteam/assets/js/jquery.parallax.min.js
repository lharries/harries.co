!(function(t, i, e, s) {
  "use strict";
  function o(i, e) {
    (this.element = i), (this.$context = t(i).data(
      "api",
      this
    ...
    t.extend(
      ...
      e,
      s
    ), (this.calibrationTimer = null), (this.calibrationFlag = !0), (this.enabled = !1), (this.depths = []), (this.raf = null), (this.bounds = null), (this.ex = 0), (this.ey = 0), (this.ew = 0), (this.eh = 0), (this.ecx = 0), (this.ecy = 0), (this.erx = 0), (this.ery = 0), (this.cx = 0), (this.cy = 0), (this.ix = 0), (this.iy = 0), (this.mx = 0), (this.my = 0), (this.vx = 0), (this.vy = 0), (this.onMouseMove = this.onMouseMove.bind(
      this
  ...
  (o.prototype.transformSupport = function(t) {
        ...
        if (n) {
          ...
          e.body ||
            (
              ...
              (m.style.background = "")
            ), m.appendChild(o), (o.style[l] =
            "translate3d(1px,1px,1px)"), (a = i
            .getComputedStyle(o)
            .getPropertyValue(h)), (r =
            a !== s &&
            a.length > 0 &&
            "none" !== a), (u.style.overflow = y), m.removeChild(o);
        }
    }
    return r;
  }), (o.prototype.ww = null), (o.prototype.wh = null), (o.prototype.wcx = null), (o.prototype.wcy = null), (o.prototype.wrx = null), (o.prototype.wry = null), (o.prototype.portrait = null), (o.prototype.desktop = !navigator.userAgent.match(
    ...
    ["-o-", "O"],
    ["-ms-", "ms"]
  ]), (o.prototype.motionSupport = !!i.DeviceMotionEvent), (o.prototype.orientationSupport = !!i.DeviceOrientationEvent), (o.prototype.orientationStatus = 0), (o.prototype.transform2DSupport = o.prototype.transformSupport(
    "2D"
  )), (o.prototype.transform3DSupport = o.prototype.transformSupport(
    "3D"
  )), (o.prototype.propertyCache = {}), (o.prototype.initialise = function() {
    "static" === this.$context.css("position") &&
      this.$context.css({ position: "relative" }), this.accelerate(
      this.$context
    ), this.updateLayers(), this.updateDimensions(), this.enable(), this.queueCalibration(
      this.calibrationDelay
    );
  }), (o.prototype.updateLayers = function() {
    (this.$layers = this.$context.find(
      ".layer"
    )), (this.depths = []), this.$layers.css({
      position: "absolute",
      display: "block",
      left: 0,
      top: 0
    }), this.$layers.first().css({ position: "relative" }), this.accelerate(
      this.$layers
    ), this.$layers.each(
    ...
    (this.ww = i.innerWidth), (this.wh = i.innerHeight), (this.wcx =
      this.ww * this.originX), (this.wcy =
      this.wh * this.originY), (this.wrx = Math.max(
      this.wcx,
      this.ww - this.wcx
    )), (this.wry = Math.max(this.wcy, this.wh - this.wcy));
  }), (o.prototype.updateBounds = function() {
    (this.bounds = this.element.getBoundingClientRect()), (this.ex = this.bounds.left), (this.ey = this.bounds.top), (this.ew = this.bounds.width), (this.eh = this.bounds.height), (this.ecx =
      this.ew * this.originX), (this.ecy =
      this.eh * this.originY), (this.erx = Math.max(
      this.ecx,
      this.ew - this.ecx
    )), (this.ery = Math.max(this.ecy, this.eh - this.ecy));
  }), (o.prototype.queueCalibration = function(t) {
    clearTimeout(this.calibrationTimer), (this.calibrationTimer = setTimeout(
    ...
    (this.calibrateX = t === s ? this.calibrateX : t), (this.calibrateY =
      i === s ? this.calibrateY : i);
  }), (o.prototype.invert = function(t, i) {
    (this.invertX = t === s ? this.invertX : t), (this.invertY =
      i === s ? this.invertY : i);
  }), (o.prototype.friction = function(t, i) {
    (this.frictionX = t === s ? this.frictionX : t), (this.frictionY =
      i === s ? this.frictionY : i);
  }), (o.prototype.scalar = function(t, i) {
    (this.scalarX = t === s ? this.scalarX : t), (this.scalarY =
      i === s ? this.scalarY : i);
  }), (o.prototype.limit = function(t, i) {
    (this.limitX = t === s ? this.limitX : t), (this.limitY =
      i === s ? this.limitY : i);
  }), (o.prototype.origin = function(t, i) {
    (this.originX = t === s ? this.originX : t), (this.originY =
      i === s ? this.originY : i);
    ...
    for (var i = 0, e = t.length; e > i; i++) {
      var s = t[i];
      this.css(s, "transform", "translate3d(0,0,0)"), this.css(
        s,
        "transform-style",
        "preserve-3d"
    ...
    (i += "px"), (e += "px"), this.transform3DSupport
    ...
    (Math.abs(t) > this.calibrationThreshold ||
      ...
      : (
        ...
        ), (this.mx *= this.ew * (this.scalarX / 100)), (this.my *=
      this.eh * (this.scalarY / 100)), isNaN(parseFloat(this.limitX)) ||
      (this.mx = this.clamp(this.mx, -this.limitX, this.limitX)), isNaN(
      parseFloat(this.limitY)
    ) || (this.my = this.clamp(this.my, -this.limitY, this.limitY)), (this.vx +=
      (this.mx - this.vx) * this.frictionX), (this.vy +=
      (this.my - this.vy) * this.frictionY);
    ...
    if (!this.desktop && null !== t.beta && null !== t.gamma) {
      ...
      this.portrait !== o &&
        ((this.portrait = o), (this.calibrationFlag = !0)), this
        .calibrationFlag &&
        (
  ...
  for (
    ...
    (window.requestAnimationFrame =
      window[i[e] + "RequestAnimationFrame"]), (window.cancelAnimationFrame =
