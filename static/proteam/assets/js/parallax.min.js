  ...
  (s.prototype.extend = function() {
    ...
    return "true" === t
      ...
      : "false" === t
        ...
        : "null" === t
          ? null
          : !isNaN(parseFloat(t)) && isFinite(t) ? parseFloat(t) : t;
        ...
        if (o) {
          ...
          i.body ||
            (
              ...
              (m.style.background = "")
            ), m.appendChild(n), (n.style[l] =
            "translate3d(1px,1px,1px)"), (r = t
            .getComputedStyle(n)
            .getPropertyValue(h)), (a =
            r !== e &&
            r.length > 0 &&
            "none" !== r), (u.style.overflow = y), m.removeChild(n);
        }
    }
    return a;
  }), (s.prototype.ww = null), (s.prototype.wh = null), (s.prototype.wcx = null), (s.prototype.wcy = null), (s.prototype.wrx = null), (s.prototype.wry = null), (s.prototype.portrait = null), (s.prototype.desktop = !navigator.userAgent.match(
    ...
    "static" === i.getPropertyValue("position") &&
      (this.element.style.position =
        "relative"), this.updateLayers(), this.updateDimensions(), this.enable(), this.queueCalibration(
      this.calibrationDelay
    );
  }), (s.prototype.updateLayers = function() {
    (this.layers = this.element.getElementsByClassName(
      "layer"
    )), (this.depths = []);
    for (var t = 0, i = this.layers.length; i > t; t++) {
      var e = this.layers[t];
      this.transform3DSupport && this.accelerate(e), (e.style.position = t
        ? "absolute"
        : "relative"), (e.style.display =
        "block"), (e.style.left = 0), (e.style.top = 0), this.depths.push(
        this.data(e, "depth") || 0
      );
    }
  }), (s.prototype.updateDimensions = function() {
    (this.ww = t.innerWidth), (this.wh = t.innerHeight), (this.wcx =
    ...
    (this.calibrateX = t === e ? this.calibrateX : t), (this.calibrateY =
      i === e ? this.calibrateY : i);
  }), (s.prototype.invert = function(t, i) {
    (this.invertX = t === e ? this.invertX : t), (this.invertY =
      i === e ? this.invertY : i);
  }), (s.prototype.friction = function(t, i) {
    (this.frictionX = t === e ? this.frictionX : t), (this.frictionY =
      i === e ? this.frictionY : i);
  }), (s.prototype.scalar = function(t, i) {
    (this.scalarX = t === e ? this.scalarX : t), (this.scalarY =
      i === e ? this.scalarY : i);
  }), (s.prototype.limit = function(t, i) {
    (this.limitX = t === e ? this.limitX : t), (this.limitY =
      i === e ? this.limitY : i);
  }), (s.prototype.origin = function(t, i) {
    (this.originX = t === e ? this.originX : t), (this.originY =
      i === e ? this.originY : i);
    ...
    this.css(t, "transform", "translate3d(0,0,0)"), this.css(
      t,
      "transform-style",
      "preserve-3d"
    ...
    if (!this.desktop && null !== t.beta && null !== t.gamma) {
      ...
      var i = (t.beta || 0) / o,
        ...
        s = this.wh > this.ww;
      this.portrait !== s &&
        ((this.portrait = s), (this.calibrationFlag = !0)), this
        .calibrationFlag &&
        (
