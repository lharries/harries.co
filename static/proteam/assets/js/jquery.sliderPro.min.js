...
!(function(a, b) {
  ...
  d.prototype = {
    ...
    update: function() {
      ...
      "horizontal" === this.settings.orientation
        ...
        : this.$slider.removeClass("sp-rtl"), (this.positionProperty =
        "horizontal" === this.settings.orientation
          ? "left"
          : "top"), (this.sizeProperty =
        "horizontal" === this.settings.orientation
          ? "width"
  ...
  (e.prototype = {
    _init: function() {
      this.$slide.attr("data-init", !0), (this.$mainImage =
      ...
      _thumbnailsOnUpdate: function() {
        ...
        this.$thumbnails.find(".sp-thumbnail").each(function(c) {
          ...
          : (
            ...
            ), this.trigger({ type: "thumbnailsUpdate" }), b.isFunction(
  ...
  (e.prototype = {
    ...
    resizeImage: function() {
      ...
      b / c <= this.width / this.height
        ...
        marginLeft:
          0.5 * (this.$thumbnailContainer.width() - this.$thumbnail.width()),
        marginTop:
          0.5 * (this.$thumbnailContainer.height() - this.$thumbnail.height())
      });
    },
    destroy: function() {
  ...
  a.SliderProSlide.prototype.destroy = function() {
    "undefined" != typeof this.layers &&
      ...
      (this.animatedLayers.length = 0), e.apply(this);
  };
  var f = function(a) {
    ...
    _setStyle: function() {
      ...
      this.position.indexOf("bottom")
        ...
        : -1 !== this.position.indexOf("top")
          ...
          : (this.verticalProperty = "center"), this._setPosition(), this.scale(
        this.scaleRatio
      );
    },
      ...
      if (
        ...
        var b =
            "center" === this.horizontalProperty
              ...
              : this.horizontalProperty,
          c =
            "center" === this.verticalProperty ? "top" : this.verticalProperty,
          d = {};
          ...
          if (this.$slider.hasClass("sp-swiping"))
            ...
            b.each(this.slides, function(a, b) {
              ...
              b.each(e.slides, function(a, b) {
                ...
                ), e.trigger({ type: "gotoSlideComplete", index: a, previousIndex: e.previousSlideIndex }), b.isFunction(e.settings.gotoSlideComplete) && e.settings.gotoSlideComplete.call(e, { type: "gotoSlideComplete", index: a, previousIndex: e.previousSlideIndex });
        ...
        if (
          (
            ...
            (this.isTouchMoving === !1 ||
              ...
              (
                b(a.target).parents(".sp-slide").find("a").off("click." + c),
      ...
      _onThumbnailTouchEnd: function(a) {
        ...
        if (
          ...
          return void (0 !== b(a.target).parents("a").length
            ? (
                b(a.target).parents("a").off("click." + c),
    ...
    this.$video.hasClass("jwplayer")
      ...
      : "undefined" != typeof this.$video.attr("data-jwplayer-id")
        ...
        : 0 !== this.$video.find("object[data*='jwplayer']").length &&
          (a = this.$video.find("object").attr("id")), (this.player = jwplayer(
      a
