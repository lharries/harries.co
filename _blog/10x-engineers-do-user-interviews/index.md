...
date: "2023-03-06T11:22:36"
category: blog
tags: engineering, product-management
description: Engineers should speak directly to users. Having a PM separating engineers from users is an anti-pattern.
---

_This post was originally written for PostHog.com._
...
![PM to engineer](/blog/10x-engineers-do-user-interviews/pm-to-engineer.png)
...
![Direct user-Engineer Interaction](/blog/10x-engineers-do-user-interviews/direct-interaction.png)
...
![User interview app](/blog/10x-engineers-do-user-interviews/user-interview-app.png)
...
![Slack feedback on feature flags](/blog/10x-engineers-do-user-interviews/feature-flags-feedback.png)
...
_There's an entire [wikipedia page](https://en.wikipedia.org/wiki/XY_problem) dedicated to this._
...
![XKCD: The general problem](/blog/10x-engineers-do-user-interviews/the-general-problem.png)
...
So here’s the challenge: **book your first user interview this week**. _Add a reminder on your phone now_
...
Have any questions, feel free to DM me on [X](https://twitter.com/lukeharries_).

## Further reading

I have a couple of book recommendations if you want to go even deeper into this topic:

- **"[The Mom Test](https://www.amazon.com/Mom-Test-customers-business-everyone/dp/1492180742)" by Rob Fitzpatrick:** Generally considered the bible of "talking to users". It's a fantastic primer on problem exploration.
